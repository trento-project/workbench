...
type ParameterMessageState string

const (
	ParameterMessageStateSAPControlPARAMETERINFO ParameterMessageState = "SAPControl-PARAMETER-INFO"

	ParameterMessageStateSAPControlPARAMETERWARNING ParameterMessageState = "SAPControl-PARAMETER-WARNING"

	ParameterMessageStateSAPControlPARAMETERERROR ParameterMessageState = "SAPControl-PARAMETER-ERROR"
)
...
type HASetMaintenanceMode struct {
	XMLName xml.Name `xml:"urn:SAPControl HASetMaintenanceMode"`

	Mode bool `xml:"mode,omitempty" json:"mode,omitempty"`

	Instanceonly bool `xml:"instance-only,omitempty" json:"instance-only,omitempty"`
}

type HACheckMaintenanceMode struct {
	XMLName xml.Name `xml:"urn:SAPControl HACheckMaintenanceMode"`
...
type CheckParameter struct {
	XMLName xml.Name `xml:"urn:SAPControl CheckParameter"`

	Profile *ArrayOfString `xml:"profile,omitempty" json:"profile,omitempty"`

	Defaultprofile *ArrayOfString `xml:"default-profile,omitempty" json:"default-profile,omitempty"`
}

type CheckParameterResponse struct {
	XMLName xml.Name `xml:"urn:SAPControl CheckParameterResponse"`

	Result *ArrayOfParameterCheck `xml:"result,omitempty" json:"result,omitempty"`
}

type StorePSE struct {
	XMLName xml.Name `xml:"urn:SAPControl StorePSE"`

	Filename string `xml:"filename,omitempty" json:"filename,omitempty"`

	Pseblob *PSEBlob `xml:"pseblob,omitempty" json:"pseblob,omitempty"`

	Psemode int32 `xml:"psemode,omitempty" json:"psemode,omitempty"`

	Overwrite bool `xml:"overwrite,omitempty" json:"overwrite,omitempty"`
}

type DeletePSE struct {
	XMLName xml.Name `xml:"urn:SAPControl DeletePSE"`

	Filename string `xml:"filename,omitempty" json:"filename,omitempty"`
}

type CheckPSE struct {
	XMLName xml.Name `xml:"urn:SAPControl CheckPSE"`
...
type CreatePSECredential struct {
	XMLName xml.Name `xml:"urn:SAPControl CreatePSECredential"`
...
type ListConfigFiles struct {
	XMLName xml.Name `xml:"urn:SAPControl ListConfigFiles"`
}

type ListConfigFilesResponse struct {
	XMLName xml.Name `xml:"urn:SAPControl ListConfigFilesResponse"`

	Configfiles *ArrayOfString `xml:"configfiles,omitempty" json:"configfiles,omitempty"`
}

type ReadConfigFile struct {
	XMLName xml.Name `xml:"urn:SAPControl ReadConfigFile"`

	Filename string `xml:"filename,omitempty" json:"filename,omitempty"`
}

type ReadConfigFileResponse struct {
	XMLName xml.Name `xml:"urn:SAPControl ReadConfigFileResponse"`
...
type WebDispGetGroupList struct {
	XMLName xml.Name `xml:"urn:SAPControl WebDispGetGroupList"`
}

type WebDispGetGroupListResponse struct {
	XMLName xml.Name `xml:"urn:SAPControl WebDispGetGroupListResponse"`

	Group *ArrayOfWebDispGroup `xml:"group,omitempty" json:"group,omitempty"`
}

type WebDispGetVirtHostList struct {
	XMLName xml.Name `xml:"urn:SAPControl WebDispGetVirtHostList"`
}

type WebDispGetVirtHostListResponse struct {
	XMLName xml.Name `xml:"urn:SAPControl WebDispGetVirtHostListResponse"`

	VirtHost *ArrayOfWebDispVirtHost `xml:"virtHost,omitempty" json:"virtHost,omitempty"`
}

type WebDispGetUrlPrefixList struct {
	XMLName xml.Name `xml:"urn:SAPControl WebDispGetUrlPrefixList"`
}

type WebDispGetUrlPrefixListResponse struct {
	XMLName xml.Name `xml:"urn:SAPControl WebDispGetUrlPrefixListResponse"`

	UrlPrefix *ArrayOfWebDispUrlPrefix `xml:"urlPrefix,omitempty" json:"urlPrefix,omitempty"`
}
...
type EnqRemoveUserLocks struct {
	XMLName xml.Name `xml:"urn:SAPControl EnqRemoveUserLocks"`
...
type GWGetConnectionList struct {
	XMLName xml.Name `xml:"urn:SAPControl GWGetConnectionList"`
}

type GWGetConnectionListResponse struct {
	XMLName xml.Name `xml:"urn:SAPControl GWGetConnectionListResponse"`

	Connection *ArrayOfGWConnection `xml:"connection,omitempty" json:"connection,omitempty"`
}

type GWGetClientList struct {
	XMLName xml.Name `xml:"urn:SAPControl GWGetClientList"`
}

type GWGetClientListResponse struct {
	XMLName xml.Name `xml:"urn:SAPControl GWGetClientListResponse"`

	Client *ArrayOfGWClient `xml:"client,omitempty" json:"client,omitempty"`
}

type GWDeleteClients struct {
	XMLName xml.Name `xml:"urn:SAPControl GWDeleteClients"`

	Index *ArrayOfGWIndex `xml:"index,omitempty" json:"index,omitempty"`
}

type GWDeleteConnections struct {
	XMLName xml.Name `xml:"urn:SAPControl GWDeleteConnections"`

	Index *ArrayOfGWIndex `xml:"index,omitempty" json:"index,omitempty"`
}

type GWCancelConnections struct {
	XMLName xml.Name `xml:"urn:SAPControl GWCancelConnections"`
...
type ArrayOfWebDispGroup struct {
	Item []*WebDispGroup `xml:"item,omitempty" json:"item,omitempty"`
}

type WebDispVirtHost struct {
	Sid string `xml:"sid,omitempty" json:"sid,omitempty"`

	Name string `xml:"name,omitempty" json:"name,omitempty"`

	Virthostnr int32 `xml:"virthostnr,omitempty" json:"virthostnr,omitempty"`

	Runlevel string `xml:"runlevel,omitempty" json:"runlevel,omitempty"`
}

type ArrayOfWebDispVirtHost struct {
	Item []*WebDispVirtHost `xml:"item,omitempty" json:"item,omitempty"`
}

type WebDispUrlPrefix struct {
	Sid string `xml:"sid,omitempty" json:"sid,omitempty"`

	Virthostnr int32 `xml:"virthostnr,omitempty" json:"virthostnr,omitempty"`

	Virthosts string `xml:"virthosts,omitempty" json:"virthosts,omitempty"`
...
type ArrayOfWebDispUrlPrefix struct {
	Item []*WebDispUrlPrefix `xml:"item,omitempty" json:"item,omitempty"`
}
...
type ParameterMessage struct {
	Category *ParameterMessageState `xml:"category,omitempty" json:"category,omitempty"`

	Message string `xml:"message,omitempty" json:"message,omitempty"`
}

type ArrayOfParameterMessage struct {
	Item []*ParameterMessage `xml:"item,omitempty" json:"item,omitempty"`
}

type ParameterCheck struct {
	Name string `xml:"name,omitempty" json:"name,omitempty"`

	Kernelvalue string `xml:"kernel-value,omitempty" json:"kernel-value,omitempty"`

	Defaultvalue string `xml:"default-value,omitempty" json:"default-value,omitempty"`

	Profilevalue string `xml:"profile-value,omitempty" json:"profile-value,omitempty"`

	Defaultdefinition string `xml:"default-definition,omitempty" json:"default-definition,omitempty"`

	Kerneldefinition string `xml:"kernel-definition,omitempty" json:"kernel-definition,omitempty"`

	Profiledefinition string `xml:"profile-definition,omitempty" json:"profile-definition,omitempty"`

	Definitionmask int32 `xml:"definition-mask,omitempty" json:"definition-mask,omitempty"`

	Defaultredefinitions int32 `xml:"default-redefinitions,omitempty" json:"default-redefinitions,omitempty"`

	Profileredefinitions int32 `xml:"profile-redefinitions,omitempty" json:"profile-redefinitions,omitempty"`

	Messages *ArrayOfParameterMessage `xml:"messages,omitempty" json:"messages,omitempty"`
}

type ArrayOfParameterCheck struct {
	Item []*ParameterCheck `xml:"item,omitempty" json:"item,omitempty"`
}

type GWConnection struct {
	Index int32 `xml:"index,omitempty" json:"index,omitempty"`

	Localluname string `xml:"local-luname,omitempty" json:"local-luname,omitempty"`

	Localtpname string `xml:"local-tpname,omitempty" json:"local-tpname,omitempty"`

	Remoteluname string `xml:"remote-luname,omitempty" json:"remote-luname,omitempty"`

	Remotetpname string `xml:"remote-tpname,omitempty" json:"remote-tpname,omitempty"`
	...
	Convid string `xml:"convid,omitempty" json:"convid,omitempty"`

	Protocol string `xml:"protocol,omitempty" json:"protocol,omitempty"`

	Lastrequest string `xml:"lastrequest,omitempty" json:"lastrequest,omitempty"`

	Errorcode int32 `xml:"errorcode,omitempty" json:"errorcode,omitempty"`

	Localaddress string `xml:"local-address,omitempty" json:"local-address,omitempty"`

	Remoteaddress string `xml:"remote-address,omitempty" json:"remote-address,omitempty"`
}

type ArrayOfGWConnection struct {
	Item []*GWConnection `xml:"item,omitempty" json:"item,omitempty"`
}

type GWClient struct {
	Index int32 `xml:"index,omitempty" json:"index,omitempty"`

	Luname string `xml:"luname,omitempty" json:"luname,omitempty"`

	Tpname string `xml:"tpname,omitempty" json:"tpname,omitempty"`
...
type ArrayOfGWClient struct {
	Item []*GWClient `xml:"item,omitempty" json:"item,omitempty"`
}

type ArrayOfGWIndex struct {
	Item []int32 `xml:"item,omitempty" json:"item,omitempty"`
}
...
type HASetMaintenanceModeResponse struct {
}

type HACheckMaintenanceModeResponse struct {
}
...
type StorePSEResponse struct {
}

type DeletePSEResponse struct {
}

type CheckPSEResponse struct {
	Psemode int32 `xml:"psemode,omitempty" json:"psemode,omitempty"`
}

type CreatePSECredentialResponse struct {
}
...
type EnqRemoveUserLocksResponse struct {
}
...
type GWDeleteClientsResponse struct {
}

type GWDeleteConnectionsResponse struct {
}

type GWCancelConnectionsResponse struct {
}
...
type SAPControlPortType interface {
	...
	/* Enables or disables HA maintenance mode of all instances or single instance of the system. */
	HASetMaintenanceMode(request *HASetMaintenanceMode) (*HASetMaintenanceModeResponse, error)

	HASetMaintenanceModeContext(ctx context.Context, request *HASetMaintenanceMode) (*HASetMaintenanceModeResponse, error)

	/* Check if HA maintenance mode is available for all instances or single instance of the system. */
	HACheckMaintenanceMode(request *HACheckMaintenanceMode) (*HACheckMaintenanceModeResponse, error)

	HACheckMaintenanceModeContext(ctx context.Context, request *HACheckMaintenanceMode) (*HACheckMaintenanceModeResponse, error)
	...
	/* Returns profile parameter details and check results. */
	CheckParameter(request *CheckParameter) (*CheckParameterResponse, error)

	CheckParameterContext(ctx context.Context, request *CheckParameter) (*CheckParameterResponse, error)

	/* stores a given PSE with given mode in instance SECUDIR directory. */
	StorePSE(request *StorePSE) (*StorePSEResponse, error)

	StorePSEContext(ctx context.Context, request *StorePSE) (*StorePSEResponse, error)

	/* deletes a PSE from instance SECUDIR directory. */
	DeletePSE(request *DeletePSE) (*DeletePSEResponse, error)

	DeletePSEContext(ctx context.Context, request *DeletePSE) (*DeletePSEResponse, error)

	/* compares an existing PSE in instance SECUDIR directory against given PSE and returns mode if PSEs match. */
	CheckPSE(request *CheckPSE) (*CheckPSEResponse, error)

	CheckPSEContext(ctx context.Context, request *CheckPSE) (*CheckPSEResponse, error)

	/* stores a credential/pin for an existing PSE in instance SECUDIR directory in cred_v2 files in SECUDUR directory. */
	CreatePSECredential(request *CreatePSECredential) (*CreatePSECredentialResponse, error)

	CreatePSECredentialContext(ctx context.Context, request *CreatePSECredential) (*CreatePSECredentialResponse, error)

	/* Returns list of configuration files. */
	ListConfigFiles(request *ListConfigFiles) (*ListConfigFilesResponse, error)

	ListConfigFilesContext(ctx context.Context, request *ListConfigFiles) (*ListConfigFilesResponse, error)

	/* Returns content of given configuration file. */
	ReadConfigFile(request *ReadConfigFile) (*ReadConfigFileResponse, error)

	ReadConfigFileContext(ctx context.Context, request *ReadConfigFile) (*ReadConfigFileResponse, error)
	...
	/* Returns a list of webdispatcher groups. */
	WebDispGetGroupList(request *WebDispGetGroupList) (*WebDispGetGroupListResponse, error)

	WebDispGetGroupListContext(ctx context.Context, request *WebDispGetGroupList) (*WebDispGetGroupListResponse, error)

	/* Returns a list of webdispatcher virtual hosts. */
	WebDispGetVirtHostList(request *WebDispGetVirtHostList) (*WebDispGetVirtHostListResponse, error)

	WebDispGetVirtHostListContext(ctx context.Context, request *WebDispGetVirtHostList) (*WebDispGetVirtHostListResponse, error)

	/* Returns a list of webdispatcher url prefixes. */
	WebDispGetUrlPrefixList(request *WebDispGetUrlPrefixList) (*WebDispGetUrlPrefixListResponse, error)

	WebDispGetUrlPrefixListContext(ctx context.Context, request *WebDispGetUrlPrefixList) (*WebDispGetUrlPrefixListResponse, error)
	...
	/* Removes all locks of given user from enque locking table. */
	EnqRemoveUserLocks(request *EnqRemoveUserLocks) (*EnqRemoveUserLocksResponse, error)

	EnqRemoveUserLocksContext(ctx context.Context, request *EnqRemoveUserLocks) (*EnqRemoveUserLocksResponse, error)
	...
	/* Returns a list of gateway connections */
	GWGetConnectionList(request *GWGetConnectionList) (*GWGetConnectionListResponse, error)

	GWGetConnectionListContext(ctx context.Context, request *GWGetConnectionList) (*GWGetConnectionListResponse, error)

	/* Returns a list of gateway clients */
	GWGetClientList(request *GWGetClientList) (*GWGetClientListResponse, error)

	GWGetClientListContext(ctx context.Context, request *GWGetClientList) (*GWGetClientListResponse, error)

	/* Deletes given gateway clients */
	GWDeleteClients(request *GWDeleteClients) (*GWDeleteClientsResponse, error)

	GWDeleteClientsContext(ctx context.Context, request *GWDeleteClients) (*GWDeleteClientsResponse, error)

	/* Deletes given gateway connections */
	GWDeleteConnections(request *GWDeleteConnections) (*GWDeleteConnectionsResponse, error)

	GWDeleteConnectionsContext(ctx context.Context, request *GWDeleteConnections) (*GWDeleteConnectionsResponse, error)

	/* Cancels given gateway connections */
	GWCancelConnections(request *GWCancelConnections) (*GWCancelConnectionsResponse, error)

	GWCancelConnectionsContext(ctx context.Context, request *GWCancelConnections) (*GWCancelConnectionsResponse, error)
}
...
func (service *sAPControlPortType) HASetMaintenanceModeContext(ctx context.Context, request *HASetMaintenanceMode) (*HASetMaintenanceModeResponse, error) {
	response := new(HASetMaintenanceModeResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) HASetMaintenanceMode(request *HASetMaintenanceMode) (*HASetMaintenanceModeResponse, error) {
	return service.HASetMaintenanceModeContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) HACheckMaintenanceModeContext(ctx context.Context, request *HACheckMaintenanceMode) (*HACheckMaintenanceModeResponse, error) {
	response := new(HACheckMaintenanceModeResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) HACheckMaintenanceMode(request *HACheckMaintenanceMode) (*HACheckMaintenanceModeResponse, error) {
	return service.HACheckMaintenanceModeContext(
		context.Background(),
		request,
	)
}
...
func (service *sAPControlPortType) CheckParameterContext(ctx context.Context, request *CheckParameter) (*CheckParameterResponse, error) {
...
func (service *sAPControlPortType) CheckParameter(request *CheckParameter) (*CheckParameterResponse, error) {
	return service.CheckParameterContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) StorePSEContext(ctx context.Context, request *StorePSE) (*StorePSEResponse, error) {
	response := new(StorePSEResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) StorePSE(request *StorePSE) (*StorePSEResponse, error) {
	return service.StorePSEContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) DeletePSEContext(ctx context.Context, request *DeletePSE) (*DeletePSEResponse, error) {
	response := new(DeletePSEResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) DeletePSE(request *DeletePSE) (*DeletePSEResponse, error) {
	return service.DeletePSEContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) CheckPSEContext(ctx context.Context, request *CheckPSE) (*CheckPSEResponse, error) {
	response := new(CheckPSEResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) CheckPSE(request *CheckPSE) (*CheckPSEResponse, error) {
	return service.CheckPSEContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) CreatePSECredentialContext(ctx context.Context, request *CreatePSECredential) (*CreatePSECredentialResponse, error) {
	response := new(CreatePSECredentialResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) CreatePSECredential(request *CreatePSECredential) (*CreatePSECredentialResponse, error) {
	return service.CreatePSECredentialContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) ListConfigFilesContext(ctx context.Context, request *ListConfigFiles) (*ListConfigFilesResponse, error) {
	response := new(ListConfigFilesResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) ListConfigFiles(request *ListConfigFiles) (*ListConfigFilesResponse, error) {
	return service.ListConfigFilesContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) ReadConfigFileContext(ctx context.Context, request *ReadConfigFile) (*ReadConfigFileResponse, error) {
	response := new(ReadConfigFileResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) ReadConfigFile(request *ReadConfigFile) (*ReadConfigFileResponse, error) {
	return service.ReadConfigFileContext(
		context.Background(),
		request,
	)
}
...
func (service *sAPControlPortType) WebDispGetGroupListContext(ctx context.Context, request *WebDispGetGroupList) (*WebDispGetGroupListResponse, error) {
	response := new(WebDispGetGroupListResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) WebDispGetGroupList(request *WebDispGetGroupList) (*WebDispGetGroupListResponse, error) {
	return service.WebDispGetGroupListContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) WebDispGetVirtHostListContext(ctx context.Context, request *WebDispGetVirtHostList) (*WebDispGetVirtHostListResponse, error) {
	response := new(WebDispGetVirtHostListResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) WebDispGetVirtHostList(request *WebDispGetVirtHostList) (*WebDispGetVirtHostListResponse, error) {
	return service.WebDispGetVirtHostListContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) WebDispGetUrlPrefixListContext(ctx context.Context, request *WebDispGetUrlPrefixList) (*WebDispGetUrlPrefixListResponse, error) {
	response := new(WebDispGetUrlPrefixListResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) WebDispGetUrlPrefixList(request *WebDispGetUrlPrefixList) (*WebDispGetUrlPrefixListResponse, error) {
	return service.WebDispGetUrlPrefixListContext(
		context.Background(),
		request,
	)
}
...
func (service *sAPControlPortType) EnqRemoveUserLocksContext(ctx context.Context, request *EnqRemoveUserLocks) (*EnqRemoveUserLocksResponse, error) {
	response := new(EnqRemoveUserLocksResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) EnqRemoveUserLocks(request *EnqRemoveUserLocks) (*EnqRemoveUserLocksResponse, error) {
	return service.EnqRemoveUserLocksContext(
		context.Background(),
		request,
	)
}
...
func (service *sAPControlPortType) GWGetConnectionListContext(ctx context.Context, request *GWGetConnectionList) (*GWGetConnectionListResponse, error) {
	response := new(GWGetConnectionListResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) GWGetConnectionList(request *GWGetConnectionList) (*GWGetConnectionListResponse, error) {
	return service.GWGetConnectionListContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) GWGetClientListContext(ctx context.Context, request *GWGetClientList) (*GWGetClientListResponse, error) {
	response := new(GWGetClientListResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) GWGetClientList(request *GWGetClientList) (*GWGetClientListResponse, error) {
	return service.GWGetClientListContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) GWDeleteClientsContext(ctx context.Context, request *GWDeleteClients) (*GWDeleteClientsResponse, error) {
	response := new(GWDeleteClientsResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) GWDeleteClients(request *GWDeleteClients) (*GWDeleteClientsResponse, error) {
	return service.GWDeleteClientsContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) GWDeleteConnectionsContext(ctx context.Context, request *GWDeleteConnections) (*GWDeleteConnectionsResponse, error) {
	response := new(GWDeleteConnectionsResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) GWDeleteConnections(request *GWDeleteConnections) (*GWDeleteConnectionsResponse, error) {
	return service.GWDeleteConnectionsContext(
		context.Background(),
		request,
	)
}

func (service *sAPControlPortType) GWCancelConnectionsContext(ctx context.Context, request *GWCancelConnections) (*GWCancelConnectionsResponse, error) {
	response := new(GWCancelConnectionsResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) GWCancelConnections(request *GWCancelConnections) (*GWCancelConnectionsResponse, error) {
	return service.GWCancelConnectionsContext(
		context.Background(),
		request,
	)
}
