...
// # Details
//
// This operator is designed to safely start a CRM cluster, ensuring that the cluster is only started if it is offline and the provided cluster ID matches the system's cluster ID.
